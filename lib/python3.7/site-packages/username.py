...
def fb():
	...
	if (fb_soup.title.get_text() != 'Page Not Found | Facebook'):
		...
		print('\033[0;31;48m' + username + ' Not Found On Facebook')
...
def instagram():
	...
	if (check_ig.status_code == 200):
		...
		print('\033[0;31;48m' + username + ' Not Found On Instagram')
...
def twitter():
	...
	if (twitter_soup.title.get_text() != 'Twitter / ?'):
		...
		print(twitter_soup.h1.get_text())
	else:
		print('\033[0;31;48m' + username + ' Not Found On Twitter')
...
def yt():
	...
	if (yt_soup.title.get_text() != 'YouTube'):
		...
		print('\033[0;31;48m' + username + ' Not Found On YouTube') 
...
def blogger():
	...
	if (blogger_soup.title.get_text() != 'Blog not found'):
		print('\033[0;32;48mFound Blog: https://' + username + '.blogspot.com')
	else:
		print('\033[0;31;48m' + username + 'Blog not found on Blogger') 
...
def gplus():
	...
	if (check_gplus.status_code == 200):
		print('\033[0;32;48mFound user: https://plus.google.com/+' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Google +')
...
def wp():
	...
	if (wp_soup.title.get_text() != 'WordPress.com'):
		print('\033[0;32;48mUser Found https://' + username + '.wordpress.com/')
	else:
		print('\033[0;31;48mBlog ' + username + ' not found')
...
def pinterest():
	...
	if (pinterest_soup.title.get_text() != 'Pinterest'):
		...
		print('\033[0;31;48m' + username + ' Not Found on Pinterest')
...
def github():
	...
	if (check_github.status_code == 200):
		...
		print('\033[0;31;48m' + username + ' Not Found On GitHub')
...
def tumblr():
	...
	if (check_tumblr.status_code == 200):
		print('\033[0;32;48mUser found http://' + username + '.tumblr.com/')
	else:
		print('\033[0;31;48m' + username + ' Not Found On Tumblr')

#FLICKR
def flickr():
	check_flickr = requests.get('https://www.flickr.com/people/' + username)
	if (check_flickr.status_code == 200):
		print('\033[0;32;48mUser found https://www.flickr.com/people/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not Found On Flickr')
...
def steam():
	...
	if (steam_soup.title.get_text() != 'Steam Community :: Error'):
		print('\033[0;32;48mUser found https://steamcommunity.com/id/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not Found On Steam')
...
def vimeo():
	...
	if (vimeo_soup.title.get_text() != 'VimeUhOh'):
		print('\033[0;32;48mUser found https://vimeo.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Vimeo')
...
def sndcloud():
	...
	if (check_sndcloud.status_code == 200):
		print('\033[0;32;48mUser found https://soundcloud.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Sound Cloud')
...
def disqus():
	...
	if (check_disqus.status_code == 200):
		print('\033[0;32;48mUser found https://disqus.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Disqus')
...
def medium():
	...
	if (check_med.status_code == 200):
		print('\033[0;32;48mUser found https://medium.com/@' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Medium')
...
def deviantart():
	...
	if (check_devart.status_code == 200):
		print('\033[0;32;48mUser found https://www.deviantart.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Deviant Art')
...
def vk():
	...
	if (check_vk.status_code == 200):
		print('\033[0;32;48mUser found https://vk.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on VK')
...
def about():
	...
	if (check_about.status_code == 200):
		print('\033[0;32;48mUser found https://about.me/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on About.me')
...
def imgur():
	...
	if (check_imgur.status_code == 200):
		print('\033[0;32;48mUser found https://imgur.com/user/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on imgur')
...
def flipboard():
	...
	if (check_flipboard.status_code == 200):
		print('\033[0;32;48mUser found https://flipboard.com/@' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Flipboard')
...
def slideshare():
	...
	if (check_slideshare.status_code == 200):
		print('\033[0;32;48mUser found https://slideshare.net/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on SlideShare')
...
def patreon():
	...
	if (check_patreon.status_code == 200):
		print('\033[0;32;48mUser found https://www.patreon.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Patreon')
...
def ebay():
	...
	if (ebay_soup.title.get_text() != 'eBay Profile - error'):
		print('\033[0;32;48mUser found https://www.ebay.com/usr/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on eBay')
...
def cashme():
	...
	if (check_cashme.status_code == 200):
		print('\033[0;32;48mUser found https://cash.me/$' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on CashMe')
...
def wikipedia():
	...
	if (check_wikipedia.status_code == 200):
		print('\033[0;32;48mUser found https://www.wikipedia.org/wiki/User:' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Wikipedia')
...
def pastebin():
	...
	if (pastebin_soup.title.get_text() != 'Pastebin.com - #1 paste tool since 2002!'):
		print('\033[0;32;48mUser found https://pastebin.com/u/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Pastebin')
...
def etsy():
	...
	if (check_etsy.status_code == 200):
		print('\033[0;32;48mUser found https://www.etsy.com/people/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Etsy')
...
def spotify():
	...
	if (check_spotify.status_code == 200):
		print('\033[0;32;48mUser found https://open.spotify.com/user/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Spotify')
...
def ello():
	...
	if (check_ello.status_code == 200):
		print('\033[0;32;48mUser found https://ello.co/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Ello')
...
def okc():
	...
	if (check_okc.status_code != 404):
		print('\033[0;32;48mUser found https://www.okcupid.com/profile/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on OKCupid')
...
def hackernews():
	...
	if (check_hnews.text != 'No such user.'):
		print('\033[0;32;48mUser found https://news.ycombinator.com/user?id=' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Hacker News')
...
def foursquare():
	...
	if (check_foursquare.status_code == 200):
		print('\033[0;32;48mUser found https://foursquare.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Four Square')
...
def bitbucket():
	...
	if (check_bitbucket.status_code == 200):
		print('\033[0;32;48mUser found https://bitbucket.org/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on BitBucket')
...
def mixcloud():
	...
	if (mixcloud_soup.title.get_text() != 'Page Not Found | Mixcloud'):
		print('\033[0;32;48mUser found https://www.mixcloud.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on MixCloud')
...
def dmotion():
	...
	if (check_dmotion.status_code == 200):
		print('\033[0;32;48mUser found https://www.dailymotion.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Daily Motion')
...
def instructables():
	...
	if (check_instructables.status_code == 200):
		print('\033[0;32;48mUser found https://www.instructables.com/member/' + username)
	else: 
		print('\033[0;31;48m' + username + ' Not found on Instructables')
...
def buzzfeed():
	...
	if (check_buzzfeed.status_code == 200):
		print('\033[0;32;48mUser found https://buzzfeed.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on BuzzFeed')
...
def tripadviser():
	...
	if (check_tripadviser.status_code == 200):
		print('\033[0;32;48mFound user https://www.tripadvisor.com/members/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Trip Adviser')
...
def trip():
	...
	if (check_trip.status_code == 200):
		print('\033[0;32;48mFound user https://www.trip.skyscanner.com/user/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Trip SkyScanner')
...
def tripit():
	...
	if (check_tripit.status_code == 200):
		print('\033[0;32;48mUser found https://www.tripit.com/people/' + username + '#/profile/basic-info')
	else:
		print('\033[0;31;48m' + username + ' Not found on Trip It')
...
def newsground():
	...
	if (check_newsground.status_code == 200):
		print('\033[0;32;48mFound user https://' + username + '.newgrounds.com')
	else:
		print('\033[0;31;48m' + username + ' Not found on News Ground')	
...
def creativemarket():
	...
	if (cmarket_soup.title.get_text() != 'Fonts, Graphics, Themes and More ~ Creative Market'):
		print('\033[0;32;48mFound user https://creativemarket.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Creative Market')
...
def codecademy():
	...
	if (check_codecademy.status_code == 200):
		print('\033[0;32;48mUser found https://www.codecademy.com/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Codecademy')
...
def colourLuv():
	...
	if (check_colourLuv.status_code == 200):
		print('\033[0;32;48mUser found https://www.colourlovers.com/lover/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Colour Lovers')
...
def trakt():
	...
	if (check_trakt.status_code == 200):
		print('\033[0;32;48mUser found https://trakt.tv/users/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Trakt')
...
def livejournal():
	...
	if (check_livejournal.status_code == 200):
		print('\033[0;32;48mUser found https://' + username + '.livejournal.com')
	else:
		print('\033[0;31;48m' + username + ' Not found on Live Journal')
...
def tracky():
	...
	if (tracky_soup.title.get_text() != 'Home &mdash; Tracky'):
		print('\033[0;32;48mUser found https://tracky.com/user/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Tracky')
...
def paypal():
	...
	if (check_paypal.status_code == 200):
		print('\033[0;32;48mUser found https://www.paypal.me/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Pay Pal')
...
def quora():
	...
	if (check_quora.status_code == 200):
		print('\033[0;32;48mUser found https://www.quora.com/profile/' + username)
	else:
		print('\033[0;31;48m' + username + ' Not found on Quora')
